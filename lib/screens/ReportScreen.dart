...
class ReportsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final Color primaryColor = isDarkMode ? Colors.blueAccent : Color.fromARGB(255, 99, 200, 183);
    final Color secondaryColor = isDarkMode ? Colors.blue : Color.fromARGB(255, 99, 200, 183);
    final Color backgroundColor = isDarkMode ? Colors.black : Color.fromARGB(255, 218, 218, 218);
        ...
        child: Padding(
          ...
          child: AspectRatio(
            ...
            child: PieChart(
              PieChartData(
                sections: [
                  PieChartSectionData(value: carbs, color: Colors.lightBlue, title: "Carbs"),

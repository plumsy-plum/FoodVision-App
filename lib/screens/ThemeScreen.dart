...
class ThemeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        backgroundColor: themeProvider.isDarkMode ? Colors.black : Colors.blue[700],
        title: Text(
          'Theme Settings',
          style: GoogleFonts.poppins(
            fontSize: 24,
            fontWeight: FontWeight.bold,
            color: themeProvider.isDarkMode ? Colors.blueAccent : Colors.white,
          ),
        ),
        centerTitle: true,
        elevation: 5,
            ...
            FadeInUp(
              ...
              child: ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  backgroundColor:
                  themeProvider.isDarkMode ? Colors.blueAccent : Colors.blue[700],

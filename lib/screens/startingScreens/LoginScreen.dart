        ...
        Positioned(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              color: (isDarkMode ? Colors.blueAccent : Colors.blue[200])!.withOpacity(0.15),
            ),
          ),
        ),
        Positioned(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              shape: BoxShape.circle,
              color: (isDarkMode ? Colors.blueAccent : Colors.blue[300])!.withOpacity(0.1),
            ),
          ),
        ),
      ],
    ...
    return FadeInUp(
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          filled: true,
          fillColor: isDarkMode ? Colors.black87 : Colors.blue[50],
          hintText: hintText,
          ...
          prefixIcon: Icon(icon, color: isDarkMode ? Colors.blueAccent : Colors.blue[700]),
